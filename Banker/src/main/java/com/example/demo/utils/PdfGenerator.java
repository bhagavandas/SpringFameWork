...
public class PdfGenerator {
	...
	public void generate(List<BankerModel> studentList, HttpServletResponse response) throws DocumentException, IOException {
	    ...
	    table.setWidths(new int[] {3,3,4,4,3});
	    ...
	    for (BankerModel student: studentList) {
	        // Adding student id
